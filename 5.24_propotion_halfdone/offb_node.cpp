        ...
        if( current_state.mode != "OFFBOARD" &&
            ...
            {       
                ...
                case 0: 
                    ...
                    if(local_pos.pose.position.z<0.8){attitude.thrust = 0.725;}
                    else if(local_pos.pose.position.z>1.2){attitude.thrust = 0.700;}
                    else {attitude.thrust = 0.725+0.1*(1-local_pos.pose.position.z);}
